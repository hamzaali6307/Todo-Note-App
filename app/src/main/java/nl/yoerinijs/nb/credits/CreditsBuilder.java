package nl.yoerinijs.nb.credits;
...
public class CreditsBuilder {
    ...
    private static String createCredits(@NonNull Context context) {
        ...
        sb.append(setFormat("Italian translation", "Unbranched", "https://github.com/unbranched"));
        sb.append(setFormat("Frequently asked questions", "Omideleayo", "https://github.com/omideleayo"));
        return sb.toString();
    }
