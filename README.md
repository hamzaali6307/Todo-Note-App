...
# Help wanted
NoteBuddy was a project to learn how to code in Android. At the moment, this project is not maintained regularly and needs a complete refactoring since NoteBuddy was not programmed with appropriate design patterns.

Nowadays, NoteBuddy is outdated and, therefore, reaches end of life soon.
...
# Changes
- Version 1.3.4: Added credits;
- Version 1.3.3: Added Italian translation by [unbranched](https://github.com/unbranched);
- Version 1.3.2: Fixed [NB-1000](https://github.com/YoeriNijs/NoteBuddy/issues/7);
